-- Archive deleted restaurants and remove from primary tables
...
CREATE TABLE deleted_restaurants (
  ...
  deleted_by   NUMBER,
  payload      CLOB,
  CONSTRAINT pk_deleted_restaurants PRIMARY KEY (archive_id)
);

CREATE SEQUENCE deleted_restaurants_seq START WITH 1;
